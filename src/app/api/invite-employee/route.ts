...
export async function POST(request: Request) {
  try {
    ...
    if (employee.status === "archived") {
      return NextResponse.json(
        { error: "Archivierte Mitarbeiter können nicht eingeladen werden." },
        { status: 400 }
      );
    }
    ...
    const displayName =
      firstName || employee.firstName || employee.lastName || "Hallo";
    ...
    const result = await resend.emails.send({
      ...
      html: `
        <div style="font-family: Arial, sans-serif; line-height: 1.5; color: #111827;">
          <h2 style="color:#1e3a8a;">Einladung zum Northwind Payroll Portal</h2>

          <p>Hallo ${displayName},</p>

          <p>
            Ihr Arbeitgeber hat Sie eingeladen, Ihre Daten für die Lohnabrechnung
            im Northwind Payroll Portal zu prüfen und zu ergänzen.
          </p>

          <p>
            Bitte richten Sie Ihren Zugang über den folgenden Button ein:
          </p>
